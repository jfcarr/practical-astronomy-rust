...
use binary as BINS;
use comet as COMT;
use coordinates as CST;
use datetime as DTT;
use eclipses as ECL;
use moon as MOONT;
use planet as PLANETT;
use practical_astronomy_rust::types as pa_types;
use sun as SUNT;

fn main() {
    println!("Succinct tests: `cargo test`");
    println!("Verbose tests: `cargo test -v -- --nocapture`");
}
